module.exports = {
  ...
  '@layout-body-background': '#f4f8fc',
  '@layout-header-background': '#2f54eb',
  '@layout-footer-background': '@layout-header-background',
  '@layout-header-height': '62px',
  '@layout-header-padding': '3px',
  '@layout-trigger-background': '#e1effc',
  '@layout-sider-background-light': '#2f58fc',
  '@font-size-base': '12px',
  ...
  '@progress-radius': '0',
  '@menu-highlight-color': '@warning-color',
  '@menu-item-active-bg': '@menu-highlight-color',
  '@menu-item-group-title-color': '@text-color',
  '@menu-dark-submenu-bg': '#2f54eb',
  '@table-header-bg': '#fafafa',
  '@table-row-hover-bg': '#fafafa',
  '@table-padding-vertical': '15px',
  '@card-background': '#cbe8ec',
  '@card-shadow': '0 4px 4px -4px rgba(0, 0, 0, 0.16), 0 3px 6px 0 rgba(0, 0, 0, 0.12),',
